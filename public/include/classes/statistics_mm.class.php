 ...
 **/
class Statistics_mm extends Base {
...
$statistics_mm = new Statistics_mm();
$statistics_mm->setDebug($debug);
$statistics_mm->setMysql($mysqli);
$statistics_mm->setShare($share_mm);
$statistics_mm->setUser($user);
$statistics_mm->setBlock($block_mm);
$statistics_mm->setMemcache($memcache);
$statistics_mm->setConfig($config);
$statistics_mm->setBitcoin($bitcoin_mm);
$statistics_mm->setErrorCodes($aErrorCodes);
