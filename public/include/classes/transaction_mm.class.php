...
class Transaction_mm extends Base {
  protected $table = 'transactions_mm';
...
$transaction_mm = new Transaction_mm();
$transaction_mm->setMemcache($memcache);
$transaction_mm->setNotification($notification);
$transaction_mm->setDebug($debug);
$transaction_mm->setMysql($mysqli);
$transaction_mm->setConfig($config);
$transaction_mm->setBlock($block_mm);
$transaction_mm->setUser($user);
$transaction_mm->setPayout($oPayout);
$transaction_mm->setErrorCodes($aErrorCodes);
?>
